...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        // Profile picture
        JLabel profile = new JLabel(new ImageIcon(new ImageIcon(ClassLoader.getSystemResource("chatapp/icons/1.png")).getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            s = skt.accept(); // Wait for the client to connect
